/* ============================================================================
 * SHORT TEST - 10k steps for forensic observation
 * ============================================================================ */

// Copy the working crystallized version but with shorter run
// Only change: TOTAL_STEPS from 100000 to 10000
...
/* ---- Protocol ------------------------------------------------------------ */
#define TOTAL_STEPS      10000  // SHORT TEST: 10k steps
#define STEPS_PER_BATCH  500
#define SAMPLE_INTERVAL  5000   // Sample every 5k steps
...
int main() {
    ...
    for (int batch = 0; batch < TOTAL_BATCHES; batch++) {
        ...
        /* Crystallize every 5k steps for short test */
        if (current_step % 5000 == 0 && current_step > 0 && spectral_available) {
